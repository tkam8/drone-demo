...
# Enter in user associated with the instance ssh key registered in GCP
ansible_user=f5user
# The location of the instance ssh key. You can mount to this location when running the tfansible container
ansible_ssh_private_key_file= "{{ GCE_SSH_KEY }}"
